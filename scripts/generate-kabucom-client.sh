...
KABU_STATION_PACKAGE="../entities/infrastructures/kabucom"

cd "$(dirname "$0")"
mkdir -p $KABU_STATION_PACKAGE
oapi-codegen -generate spec,types,client -package kabucom $KABU_STATION_DOC > "$KABU_STATION_PACKAGE/client.gen.go"